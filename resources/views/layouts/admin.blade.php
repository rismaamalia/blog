...
<body>
	...
	<div id="app">
		...
		@include('layouts.part-backend.sidebar')
		...
		<div class="content-wrapper">
					...
					<li class="nav-item dropdown">
						...
						<a class="dropdown-item" href="pages.profile.html"><i class="icon dripicons-user"></i> Profile</a>
							...
							document.getElementById('logout-form').submit();">
								...
								<i class="icon dripicons-lock-open"></i> Sign Out</a>
								<form id="logout-form" action="{{ route('logout') }}"
								method="POST" style="display: none;">@scrf</form>
						</div>
			...
			<div class="content">
				<!--START PAGE HEADER -->
				@include('layouts.part-backend.header')
				<!--END PAGE HEADER -->
				<!--START PAGE CONTENT -->
				@YIELD('content')
				<!--END PAGE CONTENT -->
